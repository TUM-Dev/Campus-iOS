...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/ASWeekSelectorView/ASWeekSelectorView.framework"
  install_framework "$BUILT_PRODUCTS_DIR/AYSlidingPickerView/AYSlidingPickerView.framework"
