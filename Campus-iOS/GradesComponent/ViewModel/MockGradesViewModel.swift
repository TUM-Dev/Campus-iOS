...
class MockGradesViewModel: GradesViewModel {
    ...
    override init(model: Model, service: GradesService, averageGradesService: AverageGradesService) {
        super.init(model: model, service: service, averageGradesService: AverageGradesService())
