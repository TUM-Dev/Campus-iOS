...
struct GradeColor {
    ...
    static func color(for grade: Double?) -> UIColor {
        ...
        case       4.0: return #colorLiteral(red: 0.9709290862, green: 0.5358461142, blue: 0, alpha: 1)
        case 4.1...5.0: return #colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1)
