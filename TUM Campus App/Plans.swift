...
class Plans {
    ...
    init(){
        plans.append(Plan(title: "Test", type: "", url: "", address: "", icon: ""))
        ...
        plans.append(Plan(title: "Campus Olympiapark", type: "image", url: "plan_campus_olymiapark", address: "Connollystraße 32, 80809 München", icon: "plan_campus_olympiapark_icon"))
        plans.append(Plan(title: "Campus Olympiapark Hallenplan", type: "image", url: "plan_campus_olympiapark", address: "Connollystraße 32, 80809 München", icon: "plan_campus_olympiapark_hallenplan_icon"))
